...
<논의 필요>산과 힐링산책이 주로 많이 연관되어 있음. → 자연을 빼면 산책까지 같이 빠져서 곤란.

무등산 옛길 - 무등산 등산로와 중복으로 삭제

광주폴리 - 위치가 여러군데인데, 이걸 따로 바꿔야 할 것 같아서 삭제

광주 문화원 시리즈 - 행사가 있긴 하지만 동사무소 느낌이라 삭제

광주광역시청소년수련원, 금호평생교육관 - 삭제

금곡동 제철유적, 복룡산, 개금산, 너릿재 옛길 - 자연/문화 많아서 삭제

약사암 - 자연을 0.5에서 1로, 문화를 0.5에서 0.25로

광주광역시립 산수도서관 - 태그로 산이 들어가있어서 산 태그만 제거

계림동잔치집, 계절따라, 공오일팔, 관가, 광주옥1947, 광후장어, 국현옥궁중팥죽 - 음식인데 1이 아니라 0.75라서 1로 수정

우일선 선교사사택 - 산, 시장, 축제, 야경 태그 삭제

다모아어린이공원 ‘홍범도 장군 흉상’ - 흉상만 있어서 문화와 예술을 낮게 책정.
